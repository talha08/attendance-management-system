<template>
  <card title="Update Password">
    <form @submit.prevent="update" @keydown="form.onKeydown($event)">
      ...
      <div class="form-group row">
        <label class="col-md-3 col-form-label text-md-right">Confirm New Password</label>
        <div class="col-md-7">
...
import { CHANGE_PASSWORD } from '../../const/api'
...
export default {
  ...
  methods: {
    async update () {
      await this.form.patch(CHANGE_PASSWORD)
      this.form.reset()
    }
  }
}
